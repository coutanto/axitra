...
ap=axitram.moment_green(model,stations,sources,40.,20.,latlon=True)

# history of source
hist = np.array([[1,7.5e20,148.0,84.0,-47.0,0.,0.,10.0],
                 [2,7.5e20,148.0,84.0,-47.0,0.,0.,10.0]])

t, sx, sy, sz = axitram.moment_conv(ap,hist,source_type=1,t0=0.5,unit=1)
...
sfunc[10]=1
t, s2x, s2y, s2z = axitram.moment_conv(ap,hist,source_type=3,t0=3,unit=1,sfunc=sfunc)
