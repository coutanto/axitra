...
#   axitra.moment_green() to compute Green's functions
#   axitra.moment_conv()  to convolve Green's functions with a source time function
...
def moment_green(model, stations, sources, duration, fmax, xl=0., latlon=False, freesurface=True, ikmax=10000, axpath='.'):
    '''
